...
<div id="d1"><button class="btn" onclick="location.href='index.php'"><i class="fa fa-home"></i></button> / <b style="color:#8f1503">View Old Notes</b> </div>
	<h1>Old Notes</h1><hr>
</nav>

<input type="text" id="myInput" placeholder=" search notes bar">
...
<div class="form-popup" id="myForm" >
  ...
  <form action="edit notes.php" class="form-container">
    ...
    <input type="text" placeholder="Enter the nid of the record you want to edit" name="id" required><br>
  ...
  <form action="" class="form-container" method="POST">
    ...
    <input type="text" placeholder="Enter the nid of the record you want to delete" name="idx" required><br>
